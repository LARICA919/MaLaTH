...
{ 
{ text = '‹ TeAm MaLaTH ›', url = 't.me/LaRiCaTeam' },
 },
 }
 }
if not msg.ControllerBot then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ 𝖢𝖨𝗂𝖼𝖪 𝖧𝖾𝗋𝖾 ›', url = 't.me/LaRiCaTeam' }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n• عذراً لاتستطيع استخدام البوت !\n• عليك الاشتراك في القناة اولاً :*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text='‹ TeAm MaLaTH ›',url="t.me/LaRiCaTeam"}}}
local msg_id = msg.id/2097152/0.5
...
{{text = '‹ TeAm MaLaTH ›', url = "https://t.me/LaRiCaTeam"}}
}
...
local tt =[[
Welcome To Source
• [Source Dove](https://t.me/LaRiCaTeam) .
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/LaRiCaTeam&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{ 
{ text = '‹ MaLaTH Team ›', url = 't.me/LaRiCaTeam' }, 
 },
 }
 }
...
if text == (Redis:get(TheMaLaTH.."MaLaTH:Name:Bot") or "كاوي") then
local NamesBot = (Redis:get(TheMaLaTH.."MaLaTH:Name:Bot") or "كاوي")
local NameBots = { 
"عمر "..NamesBot.. " شتريد ؟",
"ها سيد",
"موجود بس لتصيح",
...
local CmdStart = '*\n• اهلاً بك في بوت '..(Redis:get(TheMaLaTH.."MaLaTH:Name:Bot") or "كاوي")..
...
{ 
{ text = 'قناة السورس ›', url = 't.me/LaRiCaTeam' },{ text = '‹ لتنصيب بوت', url = 't.me/sSs_sSs' }, 
 },
{ 
